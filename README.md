...
- Replays and debugging: [docs/web-app/replays-and-debugging.md](docs/web-app/replays-and-debugging.md)
- Errors and logs: [docs/web-app/errors-and-logs.md](docs/web-app/errors-and-logs.md)
- Requests and performance: [docs/web-app/requests-and-performance.md](docs/web-app/requests-and-performance.md)
- Tests and alerts: [docs/web-app/tests-and-alerts.md](docs/web-app/tests-and-alerts.md)

## Support
If you need help, contact `support@malleon.io`.
